...
//TODO: pull out the matrixID from each projection, it should always be the same for 99% of programs
void GLWin::projectOrtho() {
	matrixID = glGetUniformLocation(programID, "MVP");
	MVP = glm::ortho(0, w, h, 0);	
}

void GLWin::projectDefault() {
}
